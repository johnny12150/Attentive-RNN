...
def main():
    ...
    # 改用全部的 train, test做 dict
    # df_train = tvh.load_df('F:/volume/trivago/data/train.csv')
    # df_test = tvh.load_df('F:/volume/trivago/data/test.csv')
    ...
    df_sessions.to_csv(NEW_DATA_PATH+OUTPUT_DF_SESSIONS, index=False)  # df_sessions.csv
